...
\section{Install Visual Studio Code in openSUSE Linux Distributions}
\label{Installation_VSCode_openSUSE}

In openSUSE distributions, you can follow following instructions to add VSCode to your software sources, for easier installation and updates.
...
Install VSCode with \texttt{zypper}:
\begin{lstlisting}[language=bash]
    sudo zypper install code # code-insiders if you want VSCode Insider
\end{lstlisting}

Also, you can install VSCode via YaST Software Management or Myrlyn Software Management.
